---
title: Spring_Ioc
date: 2018-10-18 12:48:31
categories: Spring
tags: Spring
summary: 面试被问烂的Spring_IOC
---
...
<img src="https://gakkil.gitee.io/gakkil-image/Spring_ioc/20181018125125.png"/>
...
<img src="https://gakkil.gitee.io/gakkil-image/Spring_ioc/20181018130402.png"/>
...
<font color=#00ffff size=4>好，解释了低级容器和高级容器，我们可以看看一个 IoC 启动过程是什么样子的。说白了，就是 ClassPathXmlApplicationContext 这个类，在启动时，都做了啥。</font>

下图是 ClassPathXmlApplicationContext 的构造过程，实际就是 Spring IoC 的初始化过程。
<img src="https://gakkil.gitee.io/gakkil-image/Spring_ioc/20181018131026.png"/>
...
<img src="https://gakkil.gitee.io/gakkil-image/Spring_ioc/20181018131432.png" heigth="50%"/>

从图可以看出，getBean 的操作都是在低级容器里操作的。其中有个递归操作，这个是什么意思呢？
...
所以 ApplicationContext 的 refresh 方法里面的操作不只是 IoC，是高级容器的所有功能（包括 IoC），IoC 的功能在低级容器里就可以实现。
...
<font color=#00ffff size=4>
诚然，了解 IoC 的过程，实际上为了了解 Spring 初始化时，各个接口的回调时机。例如 InitializingBean，BeanFactoryAware，ApplicationListener 等等接口。 </font>
